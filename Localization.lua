...
Localize.enUS = {
	...
	BARMENU_USABLE_DURATION = "Set usable duration",
	BARMENU_BUFFCD_DURATION = "Set cooldown duration",
	...
	BARMENU_SHOW_TEXT_USER = "Custom text",
	...
	BARMENU_BLINK_SETTINGS = "Blink settings", 
	BARMENU_BLINK_COLOR = "Blink color", 
	...
	UIPANEL_SUBTEXT1 = "These options let you customize NeedToKnow's bar groups.",
--	UIPANEL_SUBTEXT2 = "Bars work when locked. When unlocked, you can move/size bar groups and right click individual bars for more settings. You can also type '/needtoknow' or '/ntk' to lock/unlock.",
	...
	UIPANEL_APPEARANCE_SUBTEXT1 = "These options let you customize NeedToKnow's timer bars.",
