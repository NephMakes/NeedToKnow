...
Localize.enUS = {
	...
	BAR_TOOLTIP2 = "Right click bars to configure. More options in the Blizzard interface options menu. Type /needtoknow to lock and enable.",
	RESIZE_TOOLTIP = "Click and drag to change size",
	BARMENU_ENABLE = "Enable bar",
	BARMENU_CHOOSENAME = "Choose spell or ability...",
	BARMENU_CHOOSESLOT = "Choose equipment Slot...",
	...
	BARMENU_CHOOSEUNIT = "Unit to monitor",
	...
	BARMENU_BUFFORDEBUFF = "Bar Type",
	BARMENU_LAST_RAID = "Last Raid Recipient",
	BARMENU_SPELLID = "Use SpellID",
	BARMENU_HELPFUL = "Buff",
	BARMENU_HARMFUL = "Debuff",
	BARMENU_ONLYMINE = "Only show if cast by self",
	BARMENU_BARCOLOR = "Bar color",
	BARMENU_CLEARSETTINGS = "Clear settings",
	BARMENU_SHOW = "Show",
	BARMENU_SHOW_ICON = "Icon",
	BARMENU_SHOW_TEXT = "Aura Name",
	BARMENU_SHOW_COUNT = "Stack Count",
	BARMENU_SHOW_TIME = "Time Remaining",
	...
	UIPANEL_SUBTEXT1 = "These options allow you to customize NeedToKnow's timer bar groups.",
--	UIPANEL_SUBTEXT2 = "Bars work when locked. When unlocked, you can move/size bar groups and right click individual bars for more settings. You can also type '/needtoknow' or '/ntk' to lock/unlock.",
	UIPANEL_BARGROUP = "Group ",
	UIPANEL_NUMBERBARS = "Number of bars",
	UIPANEL_FIXEDDURATION = "Max bar duration",
	UIPANEL_LOCK = "Lock",
	UIPANEL_UNLOCK = "Unlock",
	UIPANEL_TOOLTIP_ENABLEGROUP = "Show and enable this group of bars",
	...
	UIPANEL_TOOLTIP_BARTEXTURE = "Choose the texture graphic for timer bars",
	CMD_RESET = "reset",

	UIPANEL_CONFIGMODE = "Config mode",
	UIPANEL_CONFIGMODE_TOOLTIP = "Unlock timer bars and make them configurable",
	UIPANEL_PLAYMODE = "Play mode",
	UIPANEL_PLAYMODE_TOOLTIP = "Lock and enable timer bars, making them click-through",

	UIPANEL_APPEARANCE_SUBTEXT1 = "These options allow you to customize NeedToKnow's timer bars.",
	UIPANEL_APPEARANCE = "Appearance",
	UIPANEL_BACKGROUNDCOLOR = "Background color",
	UIPANEL_BARSPACING = "Bar spacing",
	UIPANEL_BARPADDING = "Bar padding",
	UIPANEL_BARTEXTURE = "Bar texture",
	UIPANEL_BARFONT = "Bar font",
	UIPANEL_FONT = "Font",
	UIPANEL_FONT_OUTLINE = "Font Outline",

	UIPANEL_PROFILES_SUBTEXT1 = "These options allow you to manage profiles.  Each profile is a complete NeedToKnow configuration for one talent spec.\nBy default, profiles are per-character (and have character: in front of their name.) Per-character profiles are only available to this character.  Profiles can be switched between per-character and per-account so that the same profile can be used by multiple characters on the same account.",
	UIPANEL_CURRENTPRIMARY = "Current Primary Profile:",
	UIPANEL_CURRENTSECONDARY = "Current Secondary Profile:",
	UIPANEL_PROFILE = "Profile",
	UIPANEL_SWITCHPROFILE_TOOLTIP = "Switch to using the currently selected profile",
	UIPANEL_DELETEPROFILE_TOOLTIP = "Permanently delete the currently selected profile",
	UIPANEL_COPYPROFILE_TOOLTIP   = "Create a new profile based on the currently selected profile",
	UIPANEL_PRIVATEPROFILE_TOOLTIP  = "Make the selected profile accessible only to the current character",
	UIPANEL_PUBLICPROFILE_TOOLTIP  = "Make the selected profile accessible to all the characters on the same account",
	UIPANEL_RENAMEPROFILE_TOOLTIP  = "Change the name of this profile",
	UIPANEL_PROFILE_SWITCHTO = "Switch To",
	UIPANEL_PROFILE_DELETE = "Delete",
	UIPANEL_PROFILE_DUPLICATE = "Duplicate",
	UIPANEL_PROFILE_NAMELABEL = "New profile name:",
	UIPANEL_PROFILE_RENAME = "Rename",
	UIPANEL_PROFILE_MAKEPUBLIC = "To Account",
	UIPANEL_PROFILE_MAKEPRIVATE = "Only This Char",

	BARMENU_TOTEM = "Totem",
	BARMENU_CASTCD = "Spell or item cooldown",
	BARMENU_BUFFCD = "Internal cooldown",
	BARMENU_EQUIPSLOT = "Equipment slot cooldown",
	BARMENU_USABLE = "Reactive spell/ability",
	CMD_HIDE = "hide",
	CMD_PROFILE = "profile",
	CMD_SHOW = "show",
	BARMENU_TIMEFORMAT = "Time Format", 
	FMT_SINGLEUNIT = "Single unit (2 m)",
	FMT_TWOUNITS = "Minutes and seconds (01:10)",
	FMT_FLOAT = "Fractional Seconds (70.1)",
	BARMENU_VISUALCASTTIME = "Cast time indicator",
	BARMENU_VCT_ENABLE = "Enable for this bar",
	BARMENU_VCT_COLOR = "Overlay color",
	BARMENU_VCT_SPELL = "Choose cast time by spell...",
	BARMENU_VCT_EXTRA = "Set additional time...",
